...
## Inputs
`.audit/routes.jsonl`, `.audit/project-profile.json`, `.audit/bug-history.md` (from `auditctl`); role/scope constants; the auth middleware; `issues.md`/git fix-patterns (reveal intended ownership predicates).
